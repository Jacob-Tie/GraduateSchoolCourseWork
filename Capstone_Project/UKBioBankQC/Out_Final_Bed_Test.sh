...
#SBATCH --time=9:00:00
#SBATCH --job-name=OutputBed_test
#SBATCH --output=./slurm_out/OutputBed_test.%A-%a.out
#SBATCH --array=1-22
...
plink1.9 --bed OUTPUT_BED.bed\
                          ...
                          --keep PATH_TO_INDIV_IN_TEST_SET.txt\
                          --make-bed\
                          --out PATH_TO_BED_TEST_${SLURM_ARRAY_TASK_ID}
